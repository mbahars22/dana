                ...
                <div class="col-md-3">
                    <div class="card text-white bg-warning position-relative overflow-hidden">
                        ...
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <p class="text-end mb-0"><small><a href="blm_bayar_bln_ini.php" class="text-white text-decoration-underline">Detail</a></small></p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card text-white bg-danger position-relative overflow-hidden">
                        ...
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <div class="mt-auto text-end">
                                <small><a href="jatuh_temp.php" class="text-white text-decoration-underline">Detail</a></small>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
  document.getElementById('kategori_volume').addEventListener('change', function() {
    ...
    if (kategoriVolume === 'SPP 12') {
      form.action = 'lap_tahunan.php';  // Set action form ke lap_tahunan.php
    } else {
      form.action = 'lap_lain.php';     // Set action form ke lap_lain.php
    }
  });
