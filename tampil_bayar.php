        ...
        <div class="row">
            ...
            <div class="col-11">
               ...
               <div class="row align-items-center mb-1">
                    <div class="col-md-6">
                        <h3 class="m-0">Data Transaksi</h3>
                    </div>
...
$(document).ready(function() {
    ...
    function loadData(keyword = '', page = 1) {
        ...
        $.get('tampil_proses_bayar.php', { keyword: keyword, page: page }, function(data) {
...
function loadData(keyword = '') {
    $('#hasil-pencarian').html('<div class="text-center">Loading...</div>');
    $.get('tampil_proses_bayar.php', { keyword: keyword }, function(data) {
        $('#hasil-pencarian').html(data);
    });
}
</script>
