...
$query = "
    SELECT pembayaran_siswa.*, siswa.rombel 
    FROM pembayaran_siswa 
    JOIN siswa ON pembayaran_siswa.nis = siswa.nis 
    WHERE pembayaran_siswa.nis = ? AND pembayaran_siswa.kd_transaksi = ?
";
...
$pdf->Cell(30, 5, ': '.$siswa['rombel'], 0, 1, 'L');
