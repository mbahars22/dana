...
<body>
            ...
            <div class="col-11">
                ...
                <div class="row align-items-center mb-3">
                    ...
                    <div class="col-md-5 text-end">
                        <a href="downl_temp_siswa.php" class="btn btn-primary">
                            <i class="fas fa-download"></i> Temp xlsx
                        </a>
                        <a href="siswa_add.php" class="btn btn-primary">+ Tambah Siswa</a>
                            ...
                            if ($result_siswa->num_rows > 0) {
                                while ($row = $result_siswa->fetch_assoc()) {
                                    echo "<tr>
                                        ...
                                        <td>{$row['rombel']}</td>
                                        <td align='center'>
                                            <a href='siswa_edit.php?id={$row['id']}' class='btn btn-warning btn-sm'>Ubah</a>
                                            ...
                                            <a href='geneatebiaya.php?nis={$row['nis']}' class='btn btn-success btn-sm'>Generate Biaya</a>
    ...
    <!-- Tombol Hapus Kolektif -->
    <div>
        <button id="hapusKolektifBtn" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalHapusKolektif">
            <i class="fas fa-trash"></i> Hapus Kolektif
        </button>
    </div>
